...
const Japan = dynamic(() => import('views/agriculture/agriculture/japan'))
const PrefectureRank = dynamic(
  () => import('views/agriculture/agriculture/prefectureRank')
)
const Prefecture = dynamic(
  () => import('views/agriculture/agriculture/prefecture')
)
const City = dynamic(() => import('views/agriculture/agriculture/city'))

/**
 * fieldIdとmenuIdを指定
 */
const fieldId = 'agriculture'
const menuId = 'agriculture'
