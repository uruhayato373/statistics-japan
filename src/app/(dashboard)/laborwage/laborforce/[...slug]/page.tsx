...
const PrefectureRank = dynamic(
  () => import('views/laborwage/laborforce/prefectureRank')
)
const Prefecture = dynamic(
  () => import('views/laborwage/laborforce/prefecture')
)
const City = dynamic(() => import('views/laborwage/laborforce/city'))

/**
 * fieldIdとmenuIdを指定
 */
const fieldId = 'laborwage'
const menuId = 'laborforce'
