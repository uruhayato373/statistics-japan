...
const PrefectureRank = dynamic(
  () => import('views/landweather/weather/prefectureRank')
)
const Prefecture = dynamic(() => import('views/landweather/weather/prefecture'))
const City = dynamic(() => import('views/landweather/weather/city'))

/**
 * fieldIdとmenuIdを指定
 */
const fieldId = 'landweather'
const menuId = 'weather'
