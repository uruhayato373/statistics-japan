...
// 定数
const FIELD_ID = 'socialsecurity'
const MENU_ID = 'suicide-person'
const KIND_ID = 'prefecture-rank'

// 動的インポートとコンポーネントマッピング
const COMPONENTS: Record<string, ComponentType<ComponentProps>> = {
  'number-of-suicides': dynamic(
    () =>
      import(
        'views/socialsecurity/suicide-person/prefecture-rank/NumberOfSuicides'
      )
  ),
}
