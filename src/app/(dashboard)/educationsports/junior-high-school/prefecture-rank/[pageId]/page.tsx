...
const COMPONENTS: Record<string, ComponentType<ComponentProps>> = {
  'junior-high-schools': dynamic(
    () =>
      import(
        'views/educationsports/junior-high-school/prefecture-rank/JuniorHighSchools'
      )
  ),
  'junior-high-school-students': dynamic(
    () =>
      import(
        'views/educationsports/junior-high-school/prefecture-rank/JuniorHighSchoolStudents'
      )
  ),
  'junior-high-school-teachers': dynamic(
    () =>
      import(
        'views/educationsports/junior-high-school/prefecture-rank/JuniorHighSchoolTeachers'
      )
  ),
}
