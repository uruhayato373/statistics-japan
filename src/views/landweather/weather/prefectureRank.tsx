...
import PrefRankRainyDays from 'sections/landweather/weather/PrefRankRainyDays'
import PrefRankSunnyDays from 'sections/landweather/weather/PrefRankSunnyDays'
...
async function getComponents(routerProps: RouterProps) {
  switch (routerProps.pageId) {
    case 'rainy-days':
      return PrefRankRainyDays({ routerProps })
    case 'sunny-days':
      return PrefRankSunnyDays({ routerProps })
    default:
