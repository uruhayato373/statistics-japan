...
import SourceLowestTemperature from 'sections/landweather/weather/prefecture-rank/SourceLowestTemperature'
...
export default async function LowestTemperature({ routerProps }: Props) {
  try {
