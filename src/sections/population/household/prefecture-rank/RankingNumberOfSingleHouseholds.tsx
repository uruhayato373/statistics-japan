...
const CARD_ID = 'ranking-number-of-single-households'
...
const PAGE_ID = 'number-of-single-households'
...
// コンポーネントの描画
export default async function RankingNumberOfSingleHouseholds({
  routerProps,
  children,
}: SectionsPropsType) {
  return (
