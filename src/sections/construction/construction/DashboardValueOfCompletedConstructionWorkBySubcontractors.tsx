...
const CARD_ID = 'DashboardValueOfCompletedConstructionWorkBySubcontractors'
...
// コンポーネントの描画
export default async function DashboardValueOfCompletedConstructionWorkBySubcontractors({
  routerProps,
  prefecture,
}: Props) {
