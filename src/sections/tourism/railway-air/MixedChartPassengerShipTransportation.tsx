...
const CARD_TITLE = '旅客船輸送の推移'
const CARD_ID = 'MixedChartPassengerShipTransportation'

const ESTAT_PARAMS = {
  statsDataId: '0000010103',
  cdCat01: ['C370701', 'C3707'],
}
...
// コンポーネントの描画
export default async function MixedChartPassengerShipTransportation({
  routerProps,
  prefecture,
}: Props) {
