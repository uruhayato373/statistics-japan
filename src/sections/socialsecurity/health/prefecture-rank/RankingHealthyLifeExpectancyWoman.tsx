...
const CARD_TITLE = '健康寿命（女性）'
const CARD_ID = 'ranking-healthy-life-expectancy-woman'
...
const PAGE_ID = 'healthy-life-expectancy-woman'
...
// コンポーネントの描画
export default async function RankingHealthyLifeExpectancyWoman({
  routerProps,
  children,
}: SectionsPropsType) {
  return (
