...
const CARD_ID = 'ranking-number-of-traffic-accidents'
...
const PAGE_ID = 'number-of-traffic-accidents'
...
// コンポーネントの描画
export default async function RankingNumberOfTrafficAccidents({
  routerProps,
  children,
}: SectionsPropsType) {
  return (
